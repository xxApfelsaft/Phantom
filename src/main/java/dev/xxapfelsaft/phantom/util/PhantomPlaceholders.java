...
public class PhantomPlaceholders {
    ...
    public static synchronized void registerAll(PlaceholderRegistrar r) {
        ...
        // === Resolved Server IP & Port (Cactus only provides raw server.address) ===
        ...
        // === GPU Information (Not present in Cactus) ===
        ...
        // === RAM Percentage, Summary & GB (Cactus only has raw system.memory.*.mb) ===
        ...
        // === CPU Model Name (Cactus only has system.cpu.cores) ===
        ...
        // === Combined Display Resolution (Cactus only has width & height separately) ===
        ...
        // === Fabric Mods Count (Not in Cactus) ===
